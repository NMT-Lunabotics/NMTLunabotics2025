...
OutPin drv12_pwm(DRV12_PWM_PIN);
OutPin drv12_dir1(DRV12_DIR1_PIN);
OutPin drv12_dir2(DRV12_DIR2_PIN);
InPin potl(POTL_PIN);

OutPin drv11_pwm(DRV11_PWM_PIN);
OutPin drv11_dir1(DRV11_DIR1_PIN);
OutPin drv11_dir2(DRV11_DIR2_PIN);
InPin potr(POTR_PIN);

OutPin drv21_pwm(DRV21_PWM_PIN);
OutPin drv21_dir1(DRV21_DIR1_PIN);
OutPin drv21_dir2(DRV21_DIR2_PIN);
InPin potb(POTB_PIN);
...
Actuator act_bucket(bucket_driver, pidB, potb, AB_POT_MIN, AB_POT_MAX, AB_STROKE, act_max_vel, bucket_min, bucket_max);
